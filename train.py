...
def FSRCNN_train(train_data_file, test_data_file, model_save_path):
...
def main():
    train_file = 'train_FSRCNN.h5'
    test_file = 'test_FSRCNN.h5'
    model_save_path = 'FSRCNN_checkpoint2'
    ...
    FSRCNN_train(train_file, test_file, model_save_path)
